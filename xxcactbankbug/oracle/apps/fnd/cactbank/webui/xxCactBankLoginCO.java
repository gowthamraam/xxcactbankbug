    ...
    Boolean j=true;
      ...
      if(i)
      {
             OAApplicationModule Am = (OAApplicationModule)pageContext.getApplicationModule(webBean);
              ...
              pageContext.setRedirectURL("OA.jsp?page=/xxcactbankbug/oracle/apps/fnd/cactbank/webui/xxcactBankAdminPG");
      ...
      if(j)
         {
          ...
          pageContext.setForwardURL("OA.jsp?page=/xxcactbankbug/oracle/apps/fnd/cactbank/webui/xxCactBankDetailsPG",
          null,
      ...
      if (pageContext.getParameter(EVENT_PARAM).equals("createaccount"))
      {
        ...
        pageContext.setForwardURL("OA.jsp?page=/xxcactbankbug/oracle/apps/fnd/cactbank/webui/xxCactBankCustDetPG",
        null,
