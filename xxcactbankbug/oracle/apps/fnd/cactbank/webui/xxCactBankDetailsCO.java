/*===========================================================================+
 ...
 |  HISTORY                                                                  |
 +===========================================================================*/
package xxcactbankbug.oracle.apps.fnd.cactbank.webui;
...
import xxcactbankbug.oracle.apps.fnd.cactbank.server.XxcactTransactionVOImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.XxcactTransactionVORowImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxCactBankDetVOImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxCactBankDetVORowImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxCactBankLatestTxnImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactBankValiVORowImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactTxnTestVOImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactTxnTestVO1Impl;
import com.sun.rowset.internal.Row;
...
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactBankValiVOImpl;


import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactTxnTestVO1RowImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactTxnTestVO2Impl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactTxnTestVORowImpl;
import xxcactbankbug.oracle.apps.fnd.cactbank.server.xxcactbanktxntestBalanceVOImpl;
...
public class xxCactBankDetailsCO extends OAControllerImpl
{
  ...
  public void processFormRequest(OAPageContext pageContext, OAWebBean webBean) throws OAException
  {
    ...
    System.out.println("This happens thro");
     ...
     if(k1.equals("1")&&k2.equals("1"))
     {
         ...
         int n852=Integer.valueOf((voBalance.getCurrentRow().getAttribute("Debit")).toString());   // Obtaining Value from Balance
           String lpr=Integer.toString(n258+n852);  //Making a simple Calculation that Balance-Debit //Implemented for Bug Balance+debit
    ...
    /* Logic for inserting the second row for updating the Balance */
     ...
     pageContext.forwardImmediately("OA.jsp?page=/xxcactbankbug/oracle/apps/fnd/cactbank/webui/xxCactBankDetailsPG",
     null,
     ...
     pageContext.forwardImmediately("OA.jsp?page=/xxcactbankbug/oracle/apps/fnd/cactbank/webui/xxCactBankLoginPG",
     null,
     //OAWebBeanConstants.KEEP_MENU_CONTEXT,
     OAWebBeanConstants.KEEP_MENU_CONTEXT,
     null,
